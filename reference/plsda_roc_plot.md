...
A Receiver Operator Characteristic (ROC) plot for PLSDA models computed
by adjusting the threshold for assigning group labels from PLS
predictions.
...
A ` plsda_roc_plot ` object. This object has no `output` slots. See
